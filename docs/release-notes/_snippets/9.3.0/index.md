...
* Makes file storage size configurable. [#6224](https://github.com/elastic/fleet-server/pull/6224) [#6230](https://github.com/elastic/fleet-server/pull/6230) 
...
* Improves file upload performance for large files. [#6224](https://github.com/elastic/fleet-server/pull/6224) [#6230](https://github.com/elastic/fleet-server/pull/6230) 
