...
type Action struct {
	...
	// The minimum time provided for an action execution when scheduled by fleet-server.
	MinimumExecutionDuration string `json:"minimum_execution_duration,omitempty"`
