...
const (
	AgentApiKeyScopes agentApiKeyContextKey = "agentApiKey.Scopes"
...
// Valid indicates whether the value is a known member of the ActionRequestDiagnosticsAdditionalMetrics enum.
func (e ActionRequestDiagnosticsAdditionalMetrics) Valid() bool {
	switch e {
	case CONN:
		return true
	case CPU:
...
// Valid indicates whether the value is a known member of the ActionSettingsLogLevel enum.
func (e ActionSettingsLogLevel) Valid() bool {
	switch e {
	case ActionSettingsLogLevelDebug:
		return true
	case ActionSettingsLogLevelError:
		return true
	case ActionSettingsLogLevelInfo:
		return true
	case ActionSettingsLogLevelTrace:
		return true
	case ActionSettingsLogLevelWarning:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AuditUnenrollRequestReason enum.
...
func (e CheckinRequestStatus) Valid() bool {
	...
	case CheckinRequestStatusError:
		return true
	case CheckinRequestStatusOnline:
		return true
	case CheckinRequestStatusStarting:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the EnrollRequestType enum.
func (e EnrollRequestType) Valid() bool {
	switch e {
	case PERMANENT:
		return true
	default:
...
// Valid indicates whether the value is a known member of the EventSubtype enum.
func (e EventSubtype) Valid() bool {
	switch e {
	case EventSubtypeACKNOWLEDGED:
		return true
	case EventSubtypeCONFIG:
		return true
	case EventSubtypeDATADUMP:
		return true
	case EventSubtypeFAILED:
		return true
	case EventSubtypeINPROGRESS:
		return true
	case EventSubtypeRUNNING:
		return true
	case EventSubtypeSTARTING:
		return true
	case EventSubtypeSTOPPED:
		return true
	case EventSubtypeSTOPPING:
		return true
...
func (e StatusResponseStatus) Valid() bool {
	switch e {
	case StatusResponseStatusCONFIGURING:
		return true
	case StatusResponseStatusDEGRADED:
		return true
	case StatusResponseStatusFAILED:
		return true
	case StatusResponseStatusHEALTHY:
		return true
	case StatusResponseStatusSTARTING:
		return true
	case StatusResponseStatusSTOPPED:
		return true
	case StatusResponseStatusSTOPPING:
		return true
	case StatusResponseStatusUNKNOWN:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the UpgradeDetailsState enum.
func (e UpgradeDetailsState) Valid() bool {
	switch e {
	case UpgradeDetailsStateUPGDOWNLOADING:
		return true
	case UpgradeDetailsStateUPGEXTRACTING:
		return true
	case UpgradeDetailsStateUPGFAILED:
		return true
	case UpgradeDetailsStateUPGREPLACING:
		return true
	case UpgradeDetailsStateUPGREQUESTED:
		return true
	case UpgradeDetailsStateUPGRESTARTING:
		return true
	case UpgradeDetailsStateUPGROLLBACK:
		return true
	case UpgradeDetailsStateUPGSCHEDULED:
		return true
	case UpgradeDetailsStateUPGWATCHING:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the UpgradeMetadataFailedFailedState enum.
func (e UpgradeMetadataFailedFailedState) Valid() bool {
	switch e {
	case UpgradeMetadataFailedFailedStateUPGDOWNLOADING:
		return true
	case UpgradeMetadataFailedFailedStateUPGEXTRACTING:
		return true
	case UpgradeMetadataFailedFailedStateUPGREPLACING:
		return true
	case UpgradeMetadataFailedFailedStateUPGREQUESTED:
		return true
	case UpgradeMetadataFailedFailedStateUPGRESTARTING:
		return true
	case UpgradeMetadataFailedFailedStateUPGSCHEDULED:
		return true
	case UpgradeMetadataFailedFailedStateUPGWATCHING:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the UploadBeginRequestSrc enum.
func (e UploadBeginRequestSrc) Valid() bool {
	switch e {
	case Agent:
		return true
	case Endpoint:
...
// Valid indicates whether the value is a known member of the AgentCheckinParamsContentEncoding enum.
func (e AgentCheckinParamsContentEncoding) Valid() bool {
	switch e {
	case Gzip:
		return true
	default:
...
// agentApiKeyContextKey is the context key for agentApiKey security scheme
type agentApiKeyContextKey string
...
func (siw *ServerInterfaceWrapper) GetPGPKey(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "major", chi.URLParam(r, "major"), &major, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: ""})
	if err != nil {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "minor", chi.URLParam(r, "minor"), &minor, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: ""})
	if err != nil {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "patch", chi.URLParam(r, "patch"), &patch, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: ""})
	if err != nil {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("elastic-api-version")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "elastic-api-version", valueList[0], &ElasticApiVersion, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""})
		if err != nil {
...
func (siw *ServerInterfaceWrapper) AgentCheckin(w http.ResponseWriter, r *http.Request) {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("Content-Encoding")]; found {
		var ContentEncoding AgentCheckinParamsContentEncoding
		n := len(valueList)
		if n != 1 {
...
func (siw *ServerInterfaceWrapper) Artifact(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "sha2", chi.URLParam(r, "sha2"), &sha2, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) UploadChunk(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "chunkNum", chi.URLParam(r, "chunkNum"), &chunkNum, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: ""})
	if err != nil {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Chunk-SHA2")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Chunk-SHA2", valueList[0], &XChunkSHA2, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: true, Type: "string", Format: ""})
		if err != nil {
