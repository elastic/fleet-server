...
<<<<<<< HEAD
	github.com/elastic/elastic-agent-libs v0.19.3 // indirect
=======
	github.com/ebitengine/purego v0.8.2 // indirect
	github.com/elastic/elastic-agent-libs v0.19.4 // indirect
>>>>>>> f5a937b (build(deps): bump github.com/elastic/elastic-agent-libs from 0.19.3 to 0.19.4 (#4899))
